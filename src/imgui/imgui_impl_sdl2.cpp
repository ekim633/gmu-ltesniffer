...
//  [X] Platform: Basic IME support. App needs to call 'SDL_SetHint(SDL2/SDL.hINT_IME_SHOW_UI, "1");' before SDL_CreateWindow()!.
...
//  2022-09-26: Inputs: Disable SDL 2.0.22 new "auto capture" (SDL2/SDL.hINT_MOUSE_AUTO_CAPTURE) which prevents drag and drop across windows for multi-viewport support + don't capture when drag and dropping. (#5710)
...
//  2021-07-29: Inputs: MousePos is correctly reported when the host platform window is hovered but not focused (using SDL_GetMouseFocus() + SDL2/SDL.hINT_MOUSE_FOCUS_CLICKTHROUGH, requires SDL 2.0.5+)
...
// Note: native IME will only display if user calls SDL_SetHint(SDL2/SDL.hINT_IME_SHOW_UI, "1") _before_ SDL_CreateWindow().
...
static bool ImGui_ImplSDL2_Init(SDL_Window* window, SDL_Renderer* renderer, void* sdl_gl_context)
{
    ...
    // From 2.0.5: Set SDL2/SDL.hint to receive mouse click events on window focus, otherwise SDL doesn't emit the event.
